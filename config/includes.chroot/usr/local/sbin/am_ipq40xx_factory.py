...
class AMIPQ40XXFactory(ScriptBase):
    ...
    def run(self):
        ...
        self.pexp.expect_action(30, self.ubpmt[self.board_id], "tftpboot 0x84000000 tools/am/cfg_part.bin")
        self.pexp.expect_action(30, "Bytes transferred", "usetprotect spm off")
        ...
        self.pexp.expect_only(45, "Copying partition 'kernel' to flash memory:")
        msg(33, "urescue: uboot updated")
        self.pexp.expect_only(45, "Copying partition 'rootfs' to flash memory:")
