...
class UDMMT7622BspFactory(ScriptBase):
    ...
    def enter_diag_mode(self):
        ...
        self.pexp.expect_lnxcmd(180, self.linux_prompt, "systemctl stop unifi-core unifi-protect unifi postgresql postgresql@9.6-main postgresql@9.6-protect postgresql-cluster@9.6-main postgresql-cluster@9.6-protect-cleanup postgresql-cluster@9.6-protect ulp-go ble-http-transport")
        self.pexp.expect_lnxcmd(180, self.linux_prompt, "systemctl mask unifi-core unifi-protect unifi postgresql postgresql@ postgresql-cluster@ ulp-go ble-http-transport")
