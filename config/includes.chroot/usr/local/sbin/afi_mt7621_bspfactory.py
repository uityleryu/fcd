...
class AFIMT7621BspFactory(ScriptBase):
    def __init__(self):
        super(AFIMT7621BspFactory, self).__init__()
        self.ver_extract()
        self.init_vars()
    ...
    def init_bsp_image(self):
        self.pexp.expect_lnxcmd(180, "Please press Enter to activate this console","", self.linux_prompt)
...
def main():
    afi7621_bspfactory = AFIMT7621BspFactory()
    afi7621_bspfactory.run()
