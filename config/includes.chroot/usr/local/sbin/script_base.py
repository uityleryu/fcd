...
class ScriptBase(object):
    ...
    def registration(self, registration_only=False):
        ...
        if self.force_update_eeprom is True:
            reg_input_bin = self.eebin_path
        else:
            reg_input_bin = self.eegenbin_path
        ...
        if self.fcd_id == "" or self.sem_ver == "" or self.sw_id == "" or self.fw_ver == "":
            ...
            regparam = [
                ...
                regsubparams,
                reg_qr_field,
                "-i field=flash_eeprom,format=binary,pathname=" + reg_input_bin,
    ...
    def data_provision_64k(self, netmeta, post_en=True):
        ...
        self.tftp_get(remote=self.eegenbin, local=dstp, timeout=20, post_en=post_en)
