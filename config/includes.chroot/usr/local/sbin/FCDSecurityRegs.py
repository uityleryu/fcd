...
class fraMonitorPanel(Gtk.Frame):
    ...
    def setdirfl(self):
        ...
        GPath.templogfile[int(self.id)] = GCommon.macaddr.upper() + "_" + nowtime + ".log"
    ...
    def run_streamcmd(self):
        ...
        cmd = [
            ...
            "-pline=" + GCommon.active_product_series,
            "-pname=" + GCommon.active_product,
            "-s=" + self.id,
