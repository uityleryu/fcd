...
class USW_RTL838X_FactoryGeneral(ScriptBase):
    ...
    def init_vars(self):
        ...
        self.helpername = {
            ...
            'ed71': "helper_RTL838x_UNIFI_release",  # usw-pro-max-16 (RTK)
        }
        ...
        self.netif = {
            ...
            'ed71': "ifconfig eth0 ",  # usw-pro-max-16 (RTK)
        }
