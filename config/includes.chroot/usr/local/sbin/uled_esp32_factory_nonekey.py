...
class UFPESP32FactoryGeneral(ScriptBase):
    ...
    def init_vars(self):
        ...
        self.regsubparams = ""
        self.dev_flash_cfg = [[False, "Secure boot key"              , " secure_boot"     , self.secure_boot_key_bin  ],
                              [False, "Flash encryption key"         , None              , None                      ],
    ...
    def program_flash(self):
        ...
        if self.product_name == 'ULED-BULB' or self.product_name == 'ULED-BULB-Color':
        ...
        cmd = "esptool.py --chip esp32 -p /dev/ttyUSB{} -b 460800 --before=default_reset "         \
              "--after=hard_reset write_flash --flash_mode dio --flash_freq 40m --flash_size 8MB " \
              "{} {} {} {} {} {} {} {}".format(self.row_id,
