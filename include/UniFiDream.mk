...
$(eval $(call ProductCompress,UCG-ULTRA,FCD_$(PRD)_UCG-ULTRA_$(VER)_$(FWVER)))
$(eval $(call ProductCompress,UCG-PRO,FCD_$(PRD)_UCG-PRO_$(VER)_$(FWVER)))
...
$(eval $(call ProductCompress2,10381_a69a))
