...
$(eval $(call ProductImage,UC-AUDIENCE,FCD_$(PRD)_UC-AUDIENCE_$(VER)_$(FWVER)))
...
$(eval $(call ProductCompress,UC-AUDIENCE,FCD_$(PRD)_UC-AUDIENCE_$(VER)_$(FWVER)))
...
$(eval $(call ProductCompress2,03328_efa0))
